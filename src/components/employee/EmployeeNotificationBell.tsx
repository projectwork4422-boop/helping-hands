...
export default async function EmployeeNotificationBell() {
  ...
  return (
    <Link 
      ...
      className="relative p-2.5 text-gray-500 hover:text-black bg-white border border-gray-200 rounded-full hover:border-gray-300 hover:shadow-sm transition-all focus:outline-none focus:ring-2 focus:ring-black/5 flex items-center justify-center"
    >
